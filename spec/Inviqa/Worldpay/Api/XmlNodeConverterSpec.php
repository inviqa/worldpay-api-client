...
class XmlNodeConverterSpec extends ObjectBehavior
{
    ...
    function it_converts_a_payment_service_order_request_to_xml_format_with_high_risk_flag(Writer $writer)
    {
        $xml = OrderFactory::simpleCsePaymentServiceRequestXmlWithHighRisk();
        ...
        $this->toXml(OrderFactory::simpleCsePaymentServiceWithHighRisk())->shouldReturn($xml);
    }
}
